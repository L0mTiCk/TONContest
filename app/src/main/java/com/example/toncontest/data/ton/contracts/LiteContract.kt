package com.example.toncontest.data.ton.contracts

import com.example.toncontest.data.ton.constants.ContractMethods
import com.example.toncontest.data.ton.contracts.nft.AbstractNftContract
import com.example.toncontest.data.ton.extension.loadRemainingBits
import com.example.toncontest.data.ton.extension.loadRemainingBitsAll
import com.example.toncontest.data.ton.contracts.SmartContract
...
open class LiteContract(
    ...
    suspend fun getNftData(address: AddrStd, lastBlockId: TonNodeBlockIdExt? = null): NftItem? {
